...
CREATE TABLE IF NOT EXISTS ai_knowledge_document (
  ...
  KEY idx_ai_knowledge_doc_type (doc_type)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AI知识片段表';

INSERT INTO ai_knowledge_document
  (knowledge_code, title, content, summary, keywords, doc_type, scope, farm_stay_id, priority, status)
VALUES
  (
    'refund_rule_v1',
    '退款规则',
